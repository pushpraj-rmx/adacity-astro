  ...
  (function (e, t) {
        ...
        return (
          n.toggle
            ? (a.appendChild(
              ...
              a.appendChild(
                Me.createIcon.call(this, n.icon, {
      ...
      createTime(e, t) {
        const i = q(this.config.selectors.display[e], t),
          s = O(
            ...
            N(i, {
              class:
                `${i.class ? i.class : ""} ${this.config.classNames.display.time} `.trim(),
              "aria-label": we.get(e, this.config),
              role: "timer",
            }),
            "00:00",
        ...
        const r = q(this.config.selectors.inputs[i]),
          o = O(
            ...
            N(r, {
              ...
              role: "menuitemradio",
              class:
                `${this.config.classNames.control} ${r.class ? r.class : ""}`.trim(),
              "aria-checked": a,
              value: e,
            }),
          ),
    ...
    class Ge {
      ...
      get tagUrl() {
        ...
        return `https://go.aniview.com/api/adserver6/vast/?${Le({ AV_PUBLISHERID: "58c25bb0073ef448b1087ad6", AV_CHANNELID: "5a0458dc28a06145e4519d21", AV_URL: window.location.hostname, cb: Date.now(), AV_WIDTH: 640, AV_HEIGHT: 480, AV_CDIM2: e.publisherId })}`;
      }
    }
